	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				success: '✔️ Concluído com sucesso ✔️',
				error: {
				...
				only: {
					...
					ownerG: '⚠️ Este comando só pode ser usado pelo meu mestre! ',
					ownerB: '❌ Este comando só pode ser usado pelo meu amado mestre! ❌',
			...
			const ownerNumber = ["5573982372405@s.whatsapp.net"] // replace this with your number
			...
			switch(command) {
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://m.imgur.com/uMwLOO4.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* 𝐑𝐈𝐌𝐔𝐑𝐔\n*YOUTUBE:* https://bit.ly/3fGfXbx\n*WPP:* wa.me/5573982372405\n*INSTA:* https://bit.ly/3wtI30n\n\n\n*Digite *.bot* para ver comandos basicos para criar um bot'})
					break 
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'bot':
			     	memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://m.imgur.com/DRLQ3rU.png`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: ''})
					break
				case 'belle3':
					memein = await kagApi.memeindo()
				...
				case 'hentai':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'pervertido'})
					break
				case 'bomdia':
					memein = await kagApi.memeindo()
               ...
               case 'oichichan':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRuUpNGj2j4YFLemG-Tuhw87yQEOsNAd-J_A&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️😁'})
					break
				case 'canal':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://m.imgur.com/uMwLOO4')
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do Rimuru:*\n\n https://bit.ly/3fGfXbx'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
				...
				case 'nsfwloli':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'hehehe, lolicon'})
					break
				case 'reislin':
					memein = await kagApi.memeindo()
        ...
        case 'promote':
				...
				case 'demote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Essa pessoa aqui @${mentioned[0].split('@')[0]} Acabou de perder o adm pressionem F!`, mentioned, true)
				...
				case 'kick':
					...
					if (mentioned.length > 1) {
						...
						mentions(`acabou de levar ban : @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'listadmins':
